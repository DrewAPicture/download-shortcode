...
define( 'FDS_SCRIPT_BASE', plugin_dir_path( __FILE__ ) . 'includes/force-download.php' );

class Download_Shortcode_Old {
...
//		$this->update_script( $this->version );
	 ...
	 * or the script exists but is empty, it attempts to copy the contents of /includes/force-download.php
	 * over. On success, an "updated" notice will be displayed. On failure, an "error" notice will be displayed.
	 *
	 * @since 1.0
	 *
